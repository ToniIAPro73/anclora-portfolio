# Anclora Portfolio — Agent Project Context
...
- **PRODUCTION_RUNTIME**: [`.anclora/PRODUCTION_RUNTIME.md`](PRODUCTION_RUNTIME.md)
  - Governs real runtime architecture, hosting, Prisma ORM database connection, PRISMA_MIGRATE migration strategy, auth, and production-backed local model.
