...
Declaración de adopción AOS para `anclora-portfolio`.

## Metadatos

- Repository Name: anclora-portfolio
...
`anclora-portfolio` forma parte del ecosistema Anclora como aplicación operativa Next.js.
